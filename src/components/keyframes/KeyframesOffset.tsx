...
import { Clock, ArrowLeft, ArrowRight, Layers } from 'lucide-react';

interface KeyframesOffsetProps {
...
const KeyframesOffset: React.FC<KeyframesOffsetProps> = ({
  offsetType,
  setOffsetType,
  offsetValue,
  setOffsetValue,
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-zinc-700/50 p-4 rounded-lg">
        <h3 className="text-sm font-medium mb-3">Keyframes Offset</h3>
        <div className="space-y-4">
          {/* Common Controls */}
          <div className="space-y-4">
            {/* Offset Type */}
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="space-y-2">
              <button
                onClick={handleApplyKeyframeOffset}
                className="w-full p-2 rounded-md text-sm font-medium text-zinc-900 flex items-center justify-center gap-2"
                style={{ backgroundColor: themeColor }}
              >
              ...
              <button
                onClick={handleResetKeyframeOffset}
                className="w-full p-2 rounded-md text-sm font-medium bg-zinc-600 hover:bg-zinc-500 transition-colors flex items-center justify-center gap-2"
              >
                <ArrowLeft className="w-4 h-4" />
                Reset Keyframes
              </button>
...
export default KeyframesOffset;