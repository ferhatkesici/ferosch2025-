...
interface ProjectAndCompTabProps {
...
const ProjectAndCompTab: React.FC<ProjectAndCompTabProps> = ({ 
  projectControls, 
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-zinc-700/50 p-4 rounded-lg">
        <h3 className="text-sm font-medium mb-3">Composition Settings</h3>
        <div className="grid grid-cols-2 gap-2">
          <button
            onClick={() => setShowFpsModal(true)}
            className="p-2 rounded-md text-sm font-medium text-zinc-900"
...
export default ProjectAndCompTab;